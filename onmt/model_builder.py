...
def build_base_model(model_opt, fields, gpu, checkpoint=None, gpu_id=None,gate_attn='yes'):
    ...
    '''Build Model'''
    model = onmt.models.NMTModel(encoder, decoder,gate_attn)
...
def build_model(model_opt, opt, fields, checkpoint,gate_attn='yes'):
    logger.info('Building model...')
    model = build_base_model(model_opt, fields, use_gpu(opt), checkpoint,gate_attn=gate_attn)
    logger.info(model)
    return model
